...
public class CommonActionsOnWebPages extends MainTestBase {
    ...
    private static final String CLOSE_CHECKBOX_DELIVERY_XPATH = "xpath;(//a[contains(@class,'close-button')])[2]";
    ...
    private static final String PRODUCT_GALLERY_BONUSES_BUTTON_XPATH = "xpath;//span[@class='card-balance--inner-text-quantity']";
