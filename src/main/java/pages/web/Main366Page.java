...
public class Main366Page {
    ...
    public Main366Page getCurrentWorkMonthAndYear() {
        CURRENT_MONTH.getText();
        return this;
    }

    public Main366Page getCurrentDate() {
    ...
    public Main366Page chooseNextMonth() {
    ...
    public Main366Page chooseAnotherWorker() {
